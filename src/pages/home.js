...
import { faTrashCan, faPen, faUtensils, faStar, faLocationDot, faQuoteLeft, faQuoteRight, faCalendarDays, faPersonRunning, faFaceSadTear } from "@fortawesome/free-solid-svg-icons";
...
export default function TimelinePage() {
  ...
  function addImage(imageString64) {
    return (
      <>
        <img src={imageString64} alt="restaurant image" width="300"></img>
        <br></br>
      </>
    );
  }
  ...
  if (loading) {
    ...
    restaurants.sort((p1, p2) =>
      p1.dateVisited > p2.dateVisited
        ? -1
        : p1.dateVisited < p2.dateVisited
        ? 1
        : 0
        ...
        return (
          <>
            ...
            <div className="box has-text-centered">
              ...
              {/* image */}
              {typeof restaurant.imageContent === "undefined" ||
              restaurant.imageContent == ""
                ? console.log("No image available.")
                : addImage(restaurant.imageContent)}
              ...
              {restaurant.review ? (
                <>
                  ...
                  />
                  <span>&nbsp;&nbsp;</span>
                  <span className={styles.keepNewlines}>
                    {restaurant.review}
                  </span>
                  <span>&nbsp;&nbsp;</span>
                  <FontAwesomeIcon
